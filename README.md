...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-17-N/main/run.sh | sudo bash -s odoo-177-one 10015 20015 8069 8072 10.0.0.0/29 10.0.0.1 10.0.0.100 10.0.0.101 my-odoo-net
```
